...
namespace SpacetimeDB.Types
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        ...
        {
            AddTable(ActiveTask = new(conn));
            AddTable(Activity = new(conn));
            AddTable(ActivitySchedule = new(conn));
            AddTable(Guild = new(conn));
            AddTable(GuildInvite = new(conn));
            AddTable(GuildJoinRequest = new(conn));
            AddTable(GuildMember = new(conn));
            AddTable(GuildResourceTracker = new(conn));
            AddTable(Player = new(conn));
            AddTable(PlayerShelter = new(conn));
            AddTable(PlayerStat = new(conn));
            AddTable(PlayerStructure = new(conn));
            AddTable(ResourceTracker = new(conn));
            AddTable(StructureDefinition = new(conn));
            AddTable(StructureModifier = new(conn));
        }
    }
    ...
    public sealed class QueryBuilder
    {
        ...
        {
            new QueryBuilder().From.ActiveTask().ToSql(),
            new QueryBuilder().From.Activity().ToSql(),
            new QueryBuilder().From.ActivitySchedule().ToSql(),
            new QueryBuilder().From.Guild().ToSql(),
            new QueryBuilder().From.GuildInvite().ToSql(),
            new QueryBuilder().From.GuildJoinRequest().ToSql(),
            new QueryBuilder().From.GuildMember().ToSql(),
            new QueryBuilder().From.GuildResourceTracker().ToSql(),
            new QueryBuilder().From.Player().ToSql(),
            new QueryBuilder().From.PlayerShelter().ToSql(),
            new QueryBuilder().From.PlayerStat().ToSql(),
            new QueryBuilder().From.PlayerStructure().ToSql(),
            new QueryBuilder().From.ResourceTracker().ToSql(),
            new QueryBuilder().From.StructureDefinition().ToSql(),
            new QueryBuilder().From.StructureModifier().ToSql(),
        }
        ;
    }
    ...
    {
        public global::SpacetimeDB.Table<ActiveTask, ActiveTaskCols, ActiveTaskIxCols> ActiveTask() => new("active_task", new ActiveTaskCols("active_task"), new ActiveTaskIxCols("active_task"));
        public global::SpacetimeDB.Table<Activity, ActivityCols, ActivityIxCols> Activity() => new("activity", new ActivityCols("activity"), new ActivityIxCols("activity"));
        public global::SpacetimeDB.Table<ActivitySchedule, ActivityScheduleCols, ActivityScheduleIxCols> ActivitySchedule() => new("activity_schedule", new ActivityScheduleCols("activity_schedule"), new ActivityScheduleIxCols("activity_schedule"));
        public global::SpacetimeDB.Table<Guild, GuildCols, GuildIxCols> Guild() => new("guild", new GuildCols("guild"), new GuildIxCols("guild"));
        public global::SpacetimeDB.Table<GuildInvite, GuildInviteCols, GuildInviteIxCols> GuildInvite() => new("guild_invite", new GuildInviteCols("guild_invite"), new GuildInviteIxCols("guild_invite"));
        public global::SpacetimeDB.Table<GuildJoinRequest, GuildJoinRequestCols, GuildJoinRequestIxCols> GuildJoinRequest() => new("guild_join_request", new GuildJoinRequestCols("guild_join_request"), new GuildJoinRequestIxCols("guild_join_request"));
        public global::SpacetimeDB.Table<GuildMember, GuildMemberCols, GuildMemberIxCols> GuildMember() => new("guild_member", new GuildMemberCols("guild_member"), new GuildMemberIxCols("guild_member"));
        public global::SpacetimeDB.Table<GuildResourceTracker, GuildResourceTrackerCols, GuildResourceTrackerIxCols> GuildResourceTracker() => new("guild_resource_tracker", new GuildResourceTrackerCols("guild_resource_tracker"), new GuildResourceTrackerIxCols("guild_resource_tracker"));
        ...
        public global::SpacetimeDB.Table<PlayerShelter, PlayerShelterCols, PlayerShelterIxCols> PlayerShelter() => new("player_shelter", new PlayerShelterCols("player_shelter"), new PlayerShelterIxCols("player_shelter"));
        ...
        public global::SpacetimeDB.Table<PlayerStructure, PlayerStructureCols, PlayerStructureIxCols> PlayerStructure() => new("player_structure", new PlayerStructureCols("player_structure"), new PlayerStructureIxCols("player_structure"));
        public global::SpacetimeDB.Table<ResourceTracker, ResourceTrackerCols, ResourceTrackerIxCols> ResourceTracker() => new("resource_tracker", new ResourceTrackerCols("resource_tracker"), new ResourceTrackerIxCols("resource_tracker"));
        public global::SpacetimeDB.Table<StructureDefinition, StructureDefinitionCols, StructureDefinitionIxCols> StructureDefinition() => new("structure_definition", new StructureDefinitionCols("structure_definition"), new StructureDefinitionIxCols("structure_definition"));
        public global::SpacetimeDB.Table<StructureModifier, StructureModifierCols, StructureModifierIxCols> StructureModifier() => new("structure_modifier", new StructureModifierCols("structure_modifier"), new StructureModifierIxCols("structure_modifier"));
    }
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.AcceptJoinRequest args => Reducers.InvokeAcceptJoinRequest(eventContext, args),
                Reducer.ActivityOnInterval args => Reducers.InvokeActivityOnInterval(eventContext, args),
                Reducer.AddResourceToPlayer args => Reducers.InvokeAddResourceToPlayer(eventContext, args),
                Reducer.AddResourceToPlayerByPlayerName args => Reducers.InvokeAddResourceToPlayerByPlayerName(eventContext, args),
                Reducer.BuildStructure args => Reducers.InvokeBuildStructure(eventContext, args),
                Reducer.CancelJoinRequest args => Reducers.InvokeCancelJoinRequest(eventContext, args),
                Reducer.CreateGuild args => Reducers.InvokeCreateGuild(eventContext, args),
                Reducer.CreatePlayer args => Reducers.InvokeCreatePlayer(eventContext, args),
                Reducer.DemoteMember args => Reducers.InvokeDemoteMember(eventContext, args),
                Reducer.DisbandGuild args => Reducers.InvokeDisbandGuild(eventContext, args),
                Reducer.Focus args => Reducers.InvokeFocus(eventContext, args),
                Reducer.InviteToGuild args => Reducers.InvokeInviteToGuild(eventContext, args),
                Reducer.JoinGuild args => Reducers.InvokeJoinGuild(eventContext, args),
                Reducer.KickMember args => Reducers.InvokeKickMember(eventContext, args),
                Reducer.LeaveGuild args => Reducers.InvokeLeaveGuild(eventContext, args),
                Reducer.LootBigWood args => Reducers.InvokeLootBigWood(eventContext, args),
                Reducer.PromoteMember args => Reducers.InvokePromoteMember(eventContext, args),
                Reducer.RejectJoinRequest args => Reducers.InvokeRejectJoinRequest(eventContext, args),
                Reducer.RemoveAllScheduledEventsForParticipant args => Reducers.InvokeRemoveAllScheduledEventsForParticipant(eventContext, args),
                Reducer.RequestJoinGuild args => Reducers.InvokeRequestJoinGuild(eventContext, args),
                Reducer.Scavenge args => Reducers.InvokeScavenge(eventContext, args),
